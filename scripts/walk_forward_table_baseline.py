...
from water_quant.ml_baseline import add_month, scan_thresholds, summarize_predictions
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="reports/table_walk_forward_2025")
...
def main() -> None:
    ...
    report = [
        "# Walk-Forward Table Baseline",
        "",
        "Each month is predicted using only prior months.",
        "",
        "## Aggregate",
        "",
